...
const ExcalidrawElement = props => {
  ...
  useEffect(() => {
    Promise.resolve().then(() => _interopRequireWildcard(require('@excalidraw/excalidraw'))).then(comp => setExcalidraw(comp.default));
  });
...
export { ELEMENT_EXCALIDRAW, ExcalidrawElement, createExcalidrawPlugin, getExcalidrawElementStyles, insertExcalidraw };
