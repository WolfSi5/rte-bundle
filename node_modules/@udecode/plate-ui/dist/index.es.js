import { createStyles, getRootProps, StyledElement, StyledLeaf } from '@udecode/plate-styled-components';
...
import r$2, { useRef, useDebugValue, useContext, createElement } from 'react';
...
import { ELEMENT_BLOCKQUOTE, ELEMENT_CODE_LINE, ELEMENT_CODE_SYNTAX, ELEMENT_HR, ELEMENT_H1, withProps, ELEMENT_H2, ELEMENT_H3, ELEMENT_H4, ELEMENT_H5, ELEMENT_H6, ELEMENT_IMAGE, ELEMENT_LI, ELEMENT_LINK, ELEMENT_MEDIA_EMBED, ELEMENT_MENTION, ELEMENT_MENTION_INPUT, ELEMENT_UL, ELEMENT_OL, ELEMENT_PARAGRAPH, ELEMENT_TABLE, ELEMENT_TD, ELEMENT_TH, ELEMENT_TODO_LI, ELEMENT_TR, MARK_BOLD, MARK_CODE, MARK_HIGHLIGHT, MARK_ITALIC, MARK_KBD, MARK_SEARCH_HIGHLIGHT, MARK_STRIKETHROUGH, MARK_SUBSCRIPT, MARK_SUPERSCRIPT, MARK_UNDERLINE, createPlateEditor } from '@udecode/plate-headless';
...
var ue = /*#__PURE__*/r$2.createContext();
ue.Consumer;
var de = /*#__PURE__*/r$2.createContext(),
...
var Ge = /*#__PURE__*/r$2.createContext();
Ge.Consumer;
var Ye = {};
...
function qe(e, t, n) {
  ...
  return O.displayName = f, (C = /*#__PURE__*/r$2.forwardRef(O)).attrs = S, C.componentStyle = I, C.displayName = f, C.shouldForwardProp = A, C.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : w, C.styledComponentId = g, C.target = o ? e.target : e, C.withComponent = function (e) {
    var r = t.componentId,
        o = function (e, t) {
      if (null == e) return {};
      var n,
...
const HrElement = props => {
  ...
  return /*#__PURE__*/r$2.createElement(_StyledDiv, _extends({}, attributes, {
  ...
  }), /*#__PURE__*/r$2.createElement(_StyledHr, _extends({
...
export { HrElement, createPlateUI, createPlateUIEditor, getHrElementStyles };
