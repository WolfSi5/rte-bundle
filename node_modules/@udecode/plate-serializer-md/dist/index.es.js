import { createPluginFactory, isUrl, someHtmlElement, onKeyDownToggleMark, findHtmlParentElement, createStore, createAtomStore, SCOPE_ELEMENT, createComponentAs, createElementAs, getBlockAbove, getPluginType, isCollapsed, getAboveNode, getNodeString, useElementProps, mergeProps, useElement, useEditorRef, useComposedRef, findNodePath, setNodes, focusEditor, getPointAfter, isDefined, select, useHotkeys, getInjectedPlugins, pipeInsertDataQuery, getPluginOptions, insertNodes } from '@udecode/plate-core';
...
import React__default, { useCallback, forwardRef, useState, useLayoutEffect, useRef, useMemo, useEffect } from 'react';
...
const TextareaAutosize = /*#__PURE__*/forwardRef((props, ref) => {
  ...
  return isRerendered ? /*#__PURE__*/React__default.createElement(ReactTextareaAutosize, _extends({}, props, {
    ref: ref
  })) : null;
});
/**
...
createComponentAs(({
  ...
  return /*#__PURE__*/React__default.createElement(TextareaAutosize, htmlProps);
});
...
const MediaEmbedTweet = props => {
  ...
  return /*#__PURE__*/React__default.createElement(Tweet, htmlProps);
};
...
const Tweet = ({
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, isLoading ? loadingComponent : null, /*#__PURE__*/React__default.createElement("div", {
    key: tweetId,
    ref: containerRef
  }));
};
...
createComponentAs(props => {
  ...
  return /*#__PURE__*/React__default.createElement(Resizable, resizableProps);
});
