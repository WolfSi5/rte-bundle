import { someNode, getPluginType, getAboveNode, withoutNormalizing, removeNodes, setNodes, ELEMENT_DEFAULT, insertNodes, getBlockAbove, selectEditor, getStartPoint, getPluginTypes, findNode, getPluginOptions, insertElements, select, getNode, getEdgeBlocksAbove, hasNode, moveSelection, getEndPoint, isRangeAcrossBlocks, isRangeInSameBlock, getNodeEntry, findNodePath, getParentNode, Hotkeys, isCollapsed, replaceNodeChildren, getPointBefore, getPointAfter, getTEditor, isExpanded, collapseSelection, isElement, unwrapNodes, isText, wrapNodeChildren, createPluginFactory } from '@udecode/plate-core';
...
const getCellInNextTableRow = (editor, currentRowPath) => {
  try {
    ...
    const nextRow = getNodeEntry(editor, Path.next(currentRowPath)); // TODO: Many tables in rich text editors (Google Docs, Word),
...
export { ELEMENT_TABLE, ELEMENT_TD, ELEMENT_TH, ELEMENT_TR, createTablePlugin, deleteColumn, deleteRow, deleteTable, getCellInNextTableRow, getCellInPreviousTableRow, getCellTypes, getEmptyCellNode, getEmptyRowNode, getEmptyTableNode, getNextTableCell, getPreviousTableCell, getTableAbove, getTableColumnCount, getTableColumnIndex, getTableEntries, getTableGridAbove, getTableGridByRange, insertTable, insertTableColumn, insertTableRow, keyShiftEdges, moveSelectionFromCell, onKeyDownTable, overrideSelectionFromCell, preventDeleteTableCell, setTableColSize, withDeleteTable, withGetFragmentTable, withInsertFragmentTable, withInsertTextTable, withNormalizeTable, withSelectionTable, withTable };
