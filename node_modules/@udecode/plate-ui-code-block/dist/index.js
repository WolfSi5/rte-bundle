...
const CodeBlockSelectElement = ({
  ...
  if (slateReact.useReadOnly()) return null;
  const {
    syntaxPopularFirst
...
const CodeBlockElement = props => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement(_StyledPre, _extends({}, attributes, {
    ...
    onChange: val => {
      ...
      path && plateCore.setNodes(editor, {
        lang: val
      }, {
        at: path
      });
...
const CodeSyntaxLeaf = ({
  ...
  children,
  leaf
}) => /*#__PURE__*/React__default["default"].createElement("span", attributes, /*#__PURE__*/React__default["default"].createElement("span", {
...
const CodeBlockToolbarButton = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement(plateUiToolbar.BlockToolbarButton, _extends({
...
exports.CodeSyntaxLeaf = CodeSyntaxLeaf;
