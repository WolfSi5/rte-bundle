 ...
 * - insert link node
 */
export declare const upsertLink: <V extends Value>(editor: PlateEditor<V>, { url, text, target, insertTextInLink, insertNodesOptions, }: UpsertLinkOptions<V>) => true | undefined;
