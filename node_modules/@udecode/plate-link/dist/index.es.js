import { getPluginType, createComponentAs, createElementAs, useElementProps, createStore, findNode, getEditorString, useEditorRef, mergeProps, useComposedRef, focusEditor, toDOMRange, getPluginOptions, usePlateSelectors, getAboveNode, getStartPoint, getEndPoint, someNode, useHotkeys, isRangeAcrossBlocks, useOnClickOutside, insertNodes, withoutNormalizing, splitNodes, isElement as isElement$2, unwrapNodes, replaceNodeChildren, wrapNodes, isDefined, setNodes, isExpanded, removeNodes, getNodeProps, getNodeLeaf, isCollapsed, isStartPoint, getPreviousNodeEndPoint, isEndPoint, getNextNodeStartPoint, select, mockPlugin, getRangeBefore, getRangeFromBlockStart, collapseSelection, createPluginFactory, isUrl } from '@udecode/plate-core';
import { withRemoveEmptyNodes } from '@udecode/plate-normalizers';
import { Path } from 'slate';
import * as React from 'react';
import React__default, { useCallback, useRef, useState, useEffect, useMemo, useLayoutEffect } from 'react';
...
const LaunchIcon = props => /*#__PURE__*/React__default.createElement("svg", _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  role: "img",
  fill: "currentColor",
...
const useLink = props => {
  const _props = useElementProps({ ...props,
...
const LinkRoot = createComponentAs(props => {
...
const LinkIcon = props => /*#__PURE__*/React__default.createElement("svg", _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  role: "img",
  fill: "currentColor",
...
const LinkOffIcon = props => /*#__PURE__*/React__default.createElement("svg", _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  role: "img",
  fill: "currentColor",
...
const ShortTextIcon = props => /*#__PURE__*/React__default.createElement("svg", _extends({
  viewBox: "0 0 24 24",
  focusable: "false",
  role: "img",
  fill: "currentColor",
...
const FloatingLinkEditButton = createComponentAs(props => {
...
const FloatingLinkNewTabInput = createComponentAs(props => {
...
const FloatingLinkTextInput = createComponentAs(props => {
...
const FloatingLinkUrlInput = createComponentAs(props => {
...
const OpenLinkButton = createComponentAs(props => {
...
const UnlinkButton = createComponentAs(props => {
...
const submitFloatingLink = editor => {
  ...
  const isValid = isUrl === null || isUrl === void 0 ? void 0 : isUrl(url);
  if (!isValid) return;
...
const useVirtualFloatingLink = floatingOptions => {
...
const FloatingLinkEditRoot = createComponentAs(props => {
...
const FloatingLinkInsertRoot = createComponentAs(props => {
    ...
    if (options !== null && options !== void 0 && options.split) {
      ...
      if (linkAboveAnchor) {
        ...
        splitNodes(editor, {
          ...
          match: n => isElement$2(n) && n.type === getPluginType(editor, ELEMENT_LINK)
        });
        unwrapLink(editor, {
...
const upsertLink = (editor, {
  ...
  if (!(isUrl !== null && isUrl !== void 0 && isUrl(url))) {
    return;
  }
  ...
  const leaf = getNodeLeaf(editor, path); // if text is empty, text is url
...
const withLink = (editor, {
  ...
  const wrapLink = () => {
    withoutNormalizing(editor, () => {
      ...
      let beforeWordRange = getRangeBefore(editor, selection, rangeBeforeOptions); // if no space found before, get the range from block start
      ...
      select(editor, beforeWordRange); // wrap link
  ...
  editor.normalizeNode = ([node, path]) => {
    if (node.type === getPluginType(editor, ELEMENT_LINK)) {
      ...
      if (range && isCollapsed(range)) {
        if (isEndPoint(editor, range.focus, path)) {
          const nextPoint = getNextNodeStartPoint(editor, path); // select next text node if any
...
export { ELEMENT_LINK, FloatingLink, FloatingLinkEditButton, FloatingLinkEditRoot, FloatingLinkInsertRoot, FloatingLinkNewTabInput, FloatingLinkTextInput, FloatingLinkUrlInput, LaunchIcon, Link, LinkIcon, LinkOffIcon, LinkRoot, OpenLinkButton, ShortTextIcon, UnlinkButton, createLinkNode, createLinkPlugin, floatingLinkActions, floatingLinkSelectors, floatingLinkStore, insertLink, submitFloatingLink, triggerFloatingLink, triggerFloatingLinkEdit, triggerFloatingLinkInsert, unwrapLink, upsertLink, upsertLinkText, useFloatingLinkEdit, useFloatingLinkEditButton, useFloatingLinkEnter, useFloatingLinkEscape, useFloatingLinkInsert, useFloatingLinkNewTabInput, useFloatingLinkSelectors, useFloatingLinkTextInput, useFloatingLinkUrlInput, useLink, useOpenLinkButton, useUnlinkButton, useVirtualFloatingLink, withLink, wrapLink };
