...
const TableToolbarButton = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement(plateUiToolbar.ToolbarButton, _extends({
    active: !!(editor !== null && editor !== void 0 && editor.selection) && plateCore.someNode(editor, {
      match: {
        type
      }
    }),
    onMouseDown: !!type && editor ? plateCore.getPreventDefaultHandler(transform, editor, {
      header
    }) : undefined
  }, props));
};
