import { getParentNode, getPluginType, getAboveNode, isCollapsed, getNode, match, isRangeAcrossBlocks, someNode, isElement, getNodeEntry, withoutNormalizing, wrapNodes, moveNodes, findDescendant, getLastChildPath, moveChildren, deleteText, getBlockAbove, setElements, ELEMENT_DEFAULT, unwrapNodes, getCommonNode, isLastChild, insertElements, getNodeEntries, createPathRef, isStartPoint, isBlockTextEmptyAfterSelection, splitNodes, select, collapseSelection, getMarks, isExpanded, getPreviousPath, deleteMerge, removeNodes, getPluginOptions, findNode, Hotkeys, unhangRange, isSelectionAtBlockStart, isFirstChild, mockPlugin, isSelectionAtBlockEnd, getPointAfter, getEditorString, getChildren, getEndPoint, getStartPoint, isBlockAboveEmpty, getPlugin, insertFragment, getNodeString, getNodes, getNodeTexts, isBlock, insertEmptyElement, createPluginFactory, KEY_DESERIALIZE_HTML, onKeyDownToggleElement } from '@udecode/plate-core';
...
const removeListItem = (editor, {
  ...
  withoutNormalizing(editor, () => {
     ...
     */
    if (previousLiPath) {
      const previousLi = getNodeEntry(editor, previousLiPath); // 1
...
const insertFragmentList = editor => {
  ...
  return fragment => {
    ...
    insertFragment(editor, [textNode]); // insert text if needed
