...
const Placeholder = props => {
  ...
  const isEmptyBlock = plateCore.isElementEmpty(editor, element);
  const enabled = isEmptyBlock && (!hideOnBlur || plateCore.isCollapsed(editor.selection) && hideOnBlur && focused && selected);
...
const withPlaceholder = plateCore.createNodeHOC(Placeholder);
const withPlaceholders = plateCore.createNodesHOC(Placeholder);
