...
export interface UseDropNodeOptions extends DropTargetHookSpec<DragItemNode, unknown, {
    isOver: boolean;
}> {
    /**
 ...
 */
export declare const useDropNode: <V extends Value>(editor: TReactEditor<V>, { nodeRef, id, dropLine, onChangeDropLine, ...options }: UseDropNodeOptions) => [{
    isOver: boolean;
}, import("react-dnd").ConnectDropTarget];
//# sourceMappingURL=useDropNode.d.ts.map