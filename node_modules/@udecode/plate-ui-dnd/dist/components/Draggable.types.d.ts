...
export interface DragHandleProps extends React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement> {
    element: TElement;
    styles?: CSSProp;
}
...
//# sourceMappingURL=Draggable.types.d.ts.map