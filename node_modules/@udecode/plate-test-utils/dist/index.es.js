import { createHyperscript, createText as createText$1 } from 'slate-hyperscript';
...
const createDataTransfer = (dataMap = new Map()) => ({
  getData: type => {
    var _dataMap$get;

    return (_dataMap$get = dataMap.get(type)) !== null && _dataMap$get !== void 0 ? _dataMap$get : '';
  },
  setData: (type, value) => dataMap.set(type, value)
});

export { AnchorToken, FocusToken, Token, addAnchorToken, addFocusToken, createAnchor, createCursor, createDataTransfer, createEditor, createElement, createFocus, createFragment, createSelection, createText, getAnchorOffset, getFocusOffset, getHtmlDocument, hjsx, jsx };
