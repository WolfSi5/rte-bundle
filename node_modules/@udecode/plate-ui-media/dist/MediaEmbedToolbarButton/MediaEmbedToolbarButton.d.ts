...
export declare const MediaEmbedToolbarButton: ({ id, getEmbedUrl, ...props }: MediaEmbedToolbarButtonProps) => JSX.Element;
//# sourceMappingURL=MediaEmbedToolbarButton.d.ts.map