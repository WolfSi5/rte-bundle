...
const setPlatePlugins = (editor, {
  ...
  if (disableCorePlugins !== true) {
    ...
    if (typeof dcp !== 'object' || !(dcp !== null && dcp !== void 0 && dcp.eventEditor)) {
      ...
      plugins.push((_ref3 = editor === null || editor === void 0 ? void 0 : (_editor$pluginsByKey3 = editor.pluginsByKey) === null || _editor$pluginsByKey3 === void 0 ? void 0 : _editor$pluginsByKey3[KEY_EVENT_EDITOR]) !== null && _ref3 !== void 0 ? _ref3 : createEventEditorPlugin());
    }

    if (typeof dcp !== 'object' || !(dcp !== null && dcp !== void 0 && dcp.inlineVoid)) {
      var _ref4, _editor$pluginsByKey4;

      plugins.push((_ref4 = editor === null || editor === void 0 ? void 0 : (_editor$pluginsByKey4 = editor.pluginsByKey) === null || _editor$pluginsByKey4 === void 0 ? void 0 : _editor$pluginsByKey4[KEY_INLINE_VOID]) !== null && _ref4 !== void 0 ? _ref4 : createInlineVoidPlugin());
    }

    if (typeof dcp !== 'object' || !(dcp !== null && dcp !== void 0 && dcp.insertData)) {
      var _ref5, _editor$pluginsByKey5;

      plugins.push((_ref5 = editor === null || editor === void 0 ? void 0 : (_editor$pluginsByKey5 = editor.pluginsByKey) === null || _editor$pluginsByKey5 === void 0 ? void 0 : _editor$pluginsByKey5[KEY_INSERT_DATA]) !== null && _ref5 !== void 0 ? _ref5 : createInsertDataPlugin());
    }

    if (typeof dcp !== 'object' || !(dcp !== null && dcp !== void 0 && dcp.selection)) {
      var _ref6, _editor$pluginsByKey6;

      plugins.push((_ref6 = editor === null || editor === void 0 ? void 0 : (_editor$pluginsByKey6 = editor.pluginsByKey) === null || _editor$pluginsByKey6 === void 0 ? void 0 : _editor$pluginsByKey6[KEY_PREV_SELECTION]) !== null && _ref6 !== void 0 ? _ref6 : createPrevSelectionPlugin());
    }

    if (typeof dcp !== 'object' || !(dcp !== null && dcp !== void 0 && dcp.deserializeHtml)) {
      var _ref7, _editor$pluginsByKey7;

      plugins.push((_ref7 = editor === null || editor === void 0 ? void 0 : (_editor$pluginsByKey7 = editor.pluginsByKey) === null || _editor$pluginsByKey7 === void 0 ? void 0 : _editor$pluginsByKey7[KEY_DESERIALIZE_HTML]) !== null && _ref7 !== void 0 ? _ref7 : createDeserializeHtmlPlugin());
    }

    if (typeof dcp !== 'object' || !(dcp !== null && dcp !== void 0 && dcp.deserializeAst)) {
      var _ref8, _editor$pluginsByKey8;

      plugins.push((_ref8 = editor === null || editor === void 0 ? void 0 : (_editor$pluginsByKey8 = editor.pluginsByKey) === null || _editor$pluginsByKey8 === void 0 ? void 0 : _editor$pluginsByKey8[KEY_DESERIALIZE_AST]) !== null && _ref8 !== void 0 ? _ref8 : createDeserializeAstPlugin());
    }
  }
...
const ElementProvider = ({
  ...
  scope: SCOPE_ELEMENT
}, props), /*#__PURE__*/React__default["default"].createElement(JotaiProvider, _extends({
  initialValues: [[elementStore.atom.element, element]],
  scope: scope
...
const EditorRefEffect = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, plugins.map(plugin => /*#__PURE__*/React__default["default"].createElement(EditorRefPluginEffect, {
    key: plugin.key,
    plugin: plugin
  })));
};
...
const PlateEditable = ({
  ...
  plugins.forEach(plugin => {
    ...
    if (renderAfterEditable) {
      afterEditable = /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, afterEditable, renderAfterEditable());
    }

    if (renderBeforeEditable) {
      beforeEditable = /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, beforeEditable, renderBeforeEditable());
    }
  });
  let aboveEditable = /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, firstChildren, beforeEditable, renderEditable ? renderEditable(editable) : editable, /*#__PURE__*/React__default["default"].createElement(EditorStateEffect, {
    id: id
...
const PlateProviderContent = ({
  ...
  const value = React.useMemo(() => {
    ...
    if (!currValue) {
      currValue = editor.children.length ? editor.children : [{
  ...
  return /*#__PURE__*/React__default["default"].createElement(JotaiProvider, {
    ...
    scope: id
  }, /*#__PURE__*/React__default["default"].createElement(JotaiProvider, {
    initialValues: [[plateIdAtom, id]],
    scope: GLOBAL_PLATE_SCOPE
  }, /*#__PURE__*/React__default["default"].createElement(PlateProviderEffects, props, children)));
};
...
const PlateProvider = props => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(PlateProviderContent, _extends({
...
const PlateSlate = ({
  ...
  let aboveSlate = /*#__PURE__*/React__default["default"].createElement(slateReact.Slate, slateProps, children);
...
const Plate = ({
  ...
  const editable = /*#__PURE__*/React__default["default"].createElement(PlateSlate, {
    id: id
  }, /*#__PURE__*/React__default["default"].createElement(PlateEditable, _extends({
    id: id,
    editableRef: editableRef,
    firstChildren: firstChildren,
    renderEditable: renderEditable
  }, editableProps), children));
  return providerId ? editable : /*#__PURE__*/React__default["default"].createElement(PlateProvider, props, editable);
};
...
exports.createPlateElementComponent = createPlateElementComponent;
