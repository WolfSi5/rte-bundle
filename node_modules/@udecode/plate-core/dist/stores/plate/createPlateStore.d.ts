...
export declare const PLATE_SCOPE: unique symbol;
export declare const GLOBAL_PLATE_SCOPE: unique symbol;
export declare const plateIdAtom: import("jotai").Atom<typeof PLATE_SCOPE> & {
    write: (get: {
    ...
    }, update: typeof PLATE_SCOPE | ((prev: typeof PLATE_SCOPE) => typeof PLATE_SCOPE)) => void;
    onMount?: (<S extends (update: typeof PLATE_SCOPE | ((prev: typeof PLATE_SCOPE) => typeof PLATE_SCOPE)) => void>(setAtom: S) => void | (() => void)) | undefined;
} & {
    init: typeof PLATE_SCOPE;
};
/**
 * Get the closest `Plate` id.
 */
export declare const usePlateId: () => symbol;
export declare const createPlateStore: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>({ decorate, editor, id, isRendered, keyDecorate, keyEditor, keySelection, onChange, plugins, rawPlugins, renderElement, renderLeaf, value, ...state }?: Partial<PlateStoreState<V, E>>) => {
    plateStore: {
        atom: {
            id: import("jotai").Atom<Scope>;
            editor: import("jotai").Atom<E>;
            rawPlugins: import("jotai").Atom<import("../..").PlatePlugin<import("../..").AnyObject, V, E>[]>;
            plugins: import("jotai").Atom<import("../..").WithPlatePlugin<import("../..").AnyObject, V, E>[]>;
        ...
        extend: <ET, EN>(extendedState: ET, options?: Omit<import("../../atoms/createAtomStore").CreateAtomStoreOptions<{}, EN extends string ? EN : "plate">, "initialStore"> | undefined) => import("../../atoms/createAtomStore").AtomStoreApi<{
            id: Scope;
            editor: E;
            rawPlugins: import("../..").PlatePlugin<import("../..").AnyObject, V, E>[];
            plugins: import("../..").WithPlatePlugin<import("../..").AnyObject, V, E>[];
            value: V;
        } & import("../..").Nullable<{
            isRendered: boolean;
            keyEditor: string;
...
export declare const plateStore: {
    atom: {
        ...
        rawPlugins: import("jotai").Atom<import("../..").PlatePlugin<import("../..").AnyObject, Value, PlateEditor<Value>>[]>;
        plugins: import("jotai").Atom<import("../..").WithPlatePlugin<import("../..").AnyObject, Value, PlateEditor<Value>>[]>;
        ...
        decorate: import("jotai").Atom<{
            fn: (entry: import("../..").ENodeEntry<Value>) => import("slate").BaseRange[];
        } | null>;
        renderElement: import("jotai").Atom<{
            fn: import("../..").RenderElementFn<Value>;
        } | null>;
        renderLeaf: import("jotai").Atom<{
            fn: import("../..").RenderLeafFn<Value>;
        } | null>;
    };
    scope?: Scope | undefined;
    extend: <ET, EN>(extendedState: ET, options?: Omit<import("../../atoms/createAtomStore").CreateAtomStoreOptions<{}, EN extends string ? EN : "plate">, "initialStore"> | undefined) => import("../../atoms/createAtomStore").AtomStoreApi<{
        ...
        rawPlugins: import("../..").PlatePlugin<import("../..").AnyObject, Value, PlateEditor<Value>>[];
        plugins: import("../..").WithPlatePlugin<import("../..").AnyObject, Value, PlateEditor<Value>>[];
        value: Value;
    } & import("../..").Nullable<{
        isRendered: boolean;
        keyEditor: string;
